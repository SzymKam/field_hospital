...
class TestUserResponse(TestCase):
    ...
    def test_list_post_logged_user_no_permissions_return_403(self):
        self.client.force_login(user=self.user_1)
    ...
    def test_list_post_logged_user_have_permissions_return_201(self):
        self.client.force_login(user=self.user_1)
    ...
    def test_list_post_logged_user_have_permissions_invalid_value_return_400(self):
        self.client.force_login(user=self.user_1)
        self.permission = Permission.objects.get(codename="add_user")
        self.user_1.user_permissions.add(self.permission)
    ...
    def test_list_post_logged_user_have_permissions_invalid_password1_return_400(self):
        self.client.force_login(user=self.user_1)
        self.permission = Permission.objects.get(codename="add_user")
        self.user_1.user_permissions.add(self.permission)
    ...
    def test_list_post_logged_user_have_permissions_commom_password_return_400(self):
        self.client.force_login(user=self.user_1)
        self.permission = Permission.objects.get(codename="add_user")
        self.user_1.user_permissions.add(self.permission)
    ...
    def test_list_patch_logged_user_no_permissions_return_403(self):
        self.client.force_login(user=self.user_1)
        response = self.client.patch(path=self.url_list)
    ...
    def test_list_patch_logged_user_have_permissions_return_405(self):
        self.client.force_login(user=self.user_1)
    ...
    def test_list_delete_logged_user_no_permissions_return_405(self):
        self.client.force_login(user=self.user_1)
        response = self.client.delete(path=self.url_list)
    ...
    def test_list_delete_logged_user_have_permissions_return_405(self):
        self.client.force_login(user=self.user_1)
