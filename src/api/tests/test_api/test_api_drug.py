...
class TestDrugResponse(TestCase):
    ...
    def test_list_post_logged_user_invalid_data_invalid_dose_return_400(self):
        self.client.force_login(user=self.user)
        data = {
            "name": random.choice(DRUGS)[0],
            "dose": "dose",
    ...
    def test_list_post_logged_user_invalid_data_invalid_unit_return_400(self):
        self.client.force_login(user=self.user)
        data = {
            "name": random.choice(DRUGS)[0],
            "dose": fake.pyfloat(),
    ...
    def test_list_post_logged_user_invalid_data_invalid_dosage_form_return_400(self):
        self.client.force_login(user=self.user)
        data = {
            "name": random.choice(DRUGS)[0],
            "dose": fake.pyfloat(),
    ...
    def test_list_post_logged_user_invalid_data_invalid_treatment_return_400(self):
        self.client.force_login(user=self.user)
        data = {
            "name": random.choice(DRUGS)[0],
            "dose": fake.pyfloat(),
