...
class Patient(models.Model):
    ...
    sex = models.CharField(choices=SEX, blank=True, help_text="Patient sex", max_length=6)
    ...
    bed_number = models.CharField(choices=BED_CHOICE, blank=True, help_text="Bed number in hospital", max_length=6)
