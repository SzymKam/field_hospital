!(function (e, t, r) {
  ...
  var o = {
    ...
    n = {
      ...
      plugins: [
        Chartist.plugins.tooltip({ appendToBody: !1, pointClass: "ct-point" }),
      ],
      fullWidth: !0,
    };
  new Chartist.Bar(
  ...
  i.on("draw", function (e) {
    ...
    i.on("created", function (e) {
      ...
      return (
        t
          ...
          .elem("stop", { offset: "0%", "stop-color": "rgba(253,185,1,1)" })
          .parent()
          .elem("stop", {
            offset: "95%",
    ...
    0 < r(".chats").length && r(".chats").perfectScrollbar({ theme: "dark" });
