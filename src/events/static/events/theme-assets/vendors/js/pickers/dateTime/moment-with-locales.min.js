!(function (e, a) {
  ...
  function A(e, a) {
    return e.isValid()
      ? ((a = F(a, e.localeData())), (jt[a] = jt[a] || E(a)), jt[a](e))
  ...
  function K(a, t) {
    return function (n) {
      return null != n
        ? (Z(this, a, n), e.updateOffset(this, t), this)
        : $(this, a);
    };
  }
  function $(e, a) {
  ...
  function Z(e, a, t) {
    e.isValid() &&
      !isNaN(t) &&
      ("FullYear" === a && V(e.year()) && 1 === e.month() && 29 === e.date()
  ...
  function ee(a) {
    return null != a
      ? (X(this, a), e.updateOffset(this, !0), this)
      : $(this, "Month");
  }
  function ae() {
    function e(e, a) {
  ...
  function te(e, a, t, n, s, r, d) {
    ...
    return (
      e < 100 && e >= 0 && isFinite(_.getFullYear()) && _.setFullYear(e), _
    );
  }
  function ne(e) {
  ...
  function ce(e) {
    for (var a, t, n, s, r = 0; r < e.length; ) {
      for (
        a = (s = Le(e[r]).split("-")).length,
          t = (t = Le(e[r + 1])) ? t.split("-") : null;
        a > 0;
    ...
    if (null !== a) {
      ...
      if (((a.abbr = e), null != wn[e]))
        ...
        if (null == wn[a.parentLocale])
          return (
            vn[a.parentLocale] || (vn[a.parentLocale] = []),
            vn[a.parentLocale].push({ name: e, config: a }),
            null
          );
    ...
    if (!e._d) {
      for (
        n = Te(e),
          ...
          null != e._dayOfYear &&
            ((s = De(e._a[qt], n[qt])),
            (e._dayOfYear > U(s) || 0 === e._dayOfYear) &&
    ...
    null === t
      ? (ve(a),
        !1 === a._isValid &&
          ...
          Pe(a),
          !1 === a._isValid &&
            (delete a._isValid, e.createFromInputFallback(a))))
      : (a._d = new Date(+t[1]));
  }
  function We(a) {
    if (a._f !== e.ISO_8601)
      if (a._f !== e.RFC_2822) {
        ...
        for (s = F(a._f, a._locale).match(Ht) || [], t = 0; t < s.length; t++)
          (r = s[t]),
            (n = (_.match(J(r, a)) || [])[0]) &&
              ((d = _.substr(0, _.indexOf(n))).length > 0 &&
                l(a).unusedInput.push(d),
    ...
    return (
      ...
      null === t || (void 0 === n && "" === t)
        ...
        : ("string" == typeof t && (e._i = t = e._locale.preparse(t)),
          Y(t)
            ? new c(ke(t))
            : (d(t) ? (e._d = t) : a(n) ? Ae(e) : n ? We(e) : Ne(e),
              M(e) || (e._d = null),
              e))
    );
  }
  ...
  function ta(e, a) {
    ...
    return e.isValid() && a.isValid()
      ? ((a = Be(a, e)),
        e.isBefore(a)
          ? (t = aa(e, a))
          : (((t = aa(a, e)).milliseconds = -t.milliseconds),
            (t.months = -t.months)),
        t)
  ...
  function ra(e, a) {
    ...
    return (
      (t =
        a - s < 0
          ? (a - s) / (s - e.clone().add(n - 1, "months"))
          : (a - s) / (e.clone().add(n + 1, "months") - s)),
      -(n + t) || 0
    );
  }
  function da(e) {
    ...
    return void 0 === e
      ? this._locale._abbr
      : (null != (a = pe(e)) && (this._locale = a), this);
  }
  function _a() {
    return this._locale;
  }
  ...
  function oa(e, a, t, n, s) {
    ...
    return null == e
      ? de(this, n, s).year
      : ((r = _e(e, n, s)), a > r && (a = r), ma.call(this, e, a, t, n, s));
  }
  ...
  function Ua(e, a, t, n) {
    ...
    switch (t) {
      ...
      case "mm":
        return Ga(e)
          ? s + (a || n ? "m\xedn\xfatur" : "m\xedn\xfatum")
          : a
          ? s + "m\xedn\xfata"
          : s + "m\xedn\xfatu";
      case "hh":
        return Ga(e)
          ? s + (a || n ? "klukkustundir" : "klukkustundum")
          : s + "klukkustund";
      case "d":
  ...
  var Ln = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split(
      "_",
    ),
  ...
  (Zn.add = Rn),
    ...
    (Zn.day = Zn.days =
      function (e) {
        ...
        return null != e
          ? ((e = ie(e, this.localeData())), this.add(e - a, "d"))
          : a;
      }),
  ...
  (Bn.calendar = function (e, a, t) {
    ...
    (Bn.months = function (e, t) {
      return e
        ? a(this._months)
          ...
          : this._months[
              (this._months.isFormat || on).test(t) ? "format" : "standalone"
            ][e.month()]
        : a(this._months)
        ? this._months
    ...
    (Bn.monthsRegex = function (e) {
      return this._monthsParseExact
        ? (i(this, "_monthsRegex") || ae.call(this),
  ...
  (cs.isValid = function () {
    ...
    (e.updateLocale = function (e, a) {
      if (null != a) {
        ...
        null != wn[e] &&
          (null != wn[e].parentLocale
            ? (wn[e] = wn[e].parentLocale)
            : null != wn[e] && delete wn[e]);
      return wn[e];
    }),
    (e.locales = function () {
      return kt(wn);
    ...
    (e.relativeTimeThreshold = function (e, a) {
      return (
        void 0 !== hs[e] &&
        (void 0 === a ? hs[e] : ((hs[e] = a), "s" === e && (hs.ss = a - 1), !0))
      );
    }),
  ...
  var Xs = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split(
      "_",
    ),
    ...
    translate: function (e, a, t) {
      ...
      return 1 === t.length
        ? a
          ? n[0]
          : n[1]
        : e + " " + Yr.correctGrammaticalCase(e, n);
    },
  };
  e.defineLocale("me", {
    months:
  ...
  var gr = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
      "_",
    ),
  ...
  var Hr = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
      "_",
    ),
    ...
    translate: function (e, a, t) {
      ...
      return 1 === t.length
        ? a
          ? n[0]
          : n[1]
        : e + " " + Rr.correctGrammaticalCase(e, n);
    },
  };
    ...
    translate: function (e, a, t) {
      ...
      return 1 === t.length
        ? a
          ? n[0]
          : n[1]
        : e + " " + Cr.correctGrammaticalCase(e, n);
    },
  };
  e.defineLocale("sr", {
    months:
  ...
  var Ur = "pagh_wa\u2019_cha\u2019_wej_loS_vagh_jav_Soch_chorgh_Hut".split(
    "_",
  );
  e.defineLocale("tlh", {
    months:
  ...
  e.defineLocale("tr", {
    ...
    dayOfMonthOrdinalParse:
      /\d{1,2}'(inci|nci|\xfcnc\xfc|nc\u0131|uncu|\u0131nc\u0131)/,
    ordinal: function (e) {
      if (0 === e) return e + "'\u0131nc\u0131";
      var a = e % 10,
        t = (e % 100) - a,
