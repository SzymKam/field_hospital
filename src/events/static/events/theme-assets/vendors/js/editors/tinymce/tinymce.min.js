  ...
  r(l, [], function () {
      ...
      function o(e) {
        (this.walk = function (t, n) {
          ...
          if (
            ...
            1 == d.nodeType && d.hasChildNodes() && (d = i(d, f)),
            c == d)
          )
            return n(r([c]));
      ...
      return function (i, a) {
        ...
        function l(t) {
          ...
          (n = t.screenX - B),
            ...
            (z = 5 > z ? 5 : z),
            (i =
              "IMG" == _.nodeName && a.settings.resize_img_proportional !== !1
                ? !e.modifierPressed(t)
                : e.modifierPressed(t) ||
                  ("IMG" == _.nodeName && R[2] * R[3] !== 0)),
            i &&
              ($(n) > $(r)
                ? ((z = q(F * O)), (F = q(z / O)))
                : ((F = q(z / O)), (z = q(F * O)))),
            N.setStyles(S, { width: F, height: z }),
            (o = R.startPos.x + n),
            (s = R.startPos.y + r),
            (o = o > 0 ? o : 0),
            (s = s > 0 ? s : 0),
            N.setStyles(k, { left: o, top: s, display: "block" }),
            (k.innerHTML = F + " &times; " + z),
            R[2] < 0 &&
              S.clientWidth <= F &&
              N.setStyle(S, "left", L + (P - F)),
            R[3] < 0 &&
              S.clientHeight <= z &&
              N.setStyle(S, "top", M + (H - z)),
            (n = j.scrollWidth - Y),
            (r = j.scrollHeight - X),
            n + r !== 0 && N.setStyles(k, { left: o - n, top: s - r }),
            I ||
              (a.fire("ObjectResizeStart", { target: _, width: P, height: H }),
              (I = !0));
        }
        function c() {
          function e(e, t) {
            t &&
              (_.style[e] || !a.schema.isValid(_.nodeName.toLowerCase(), e)
                ? N.setStyle(_, e, t)
                : N.setAttrib(_, e, t));
          }
          (I = !1),
            e("width", F),
            e("height", z),
            N.unbind(U, "mousemove", l),
            N.unbind(U, "mouseup", c),
            W != U && (N.unbind(W, "mousemove", l), N.unbind(W, "mouseup", c)),
            N.remove(S),
            N.remove(k),
            (V && "TABLE" != _.nodeName) || u(_),
            a.fire("ObjectResized", { target: _, width: F, height: z }),
        ...
        function u(e, t, n) {
          ...
          d(),
            ...
            _ != e && (y(), (_ = e), (F = z = 0)),
            (f = a.fire("ObjectSelected", { target: e })),
            s(e) && !f.isDefaultPrevented()
              ? E(T, function (e, i) {
                  function a(t) {
                    (B = t.screenX),
                      (D = t.screenY),
                      ...
                      (O = H / P),
                      (R = e),
                      (e.startPos = { x: o * e[0] + L, y: u * e[1] + M }),
                      (Y = j.scrollWidth),
                      (X = j.scrollHeight),
                      (S = _.cloneNode(!0)),
                      ...
                      (S.contentEditable = !1),
                      (S.unSelectabe = !0),
                      N.setStyles(S, { left: L, top: M, margin: 0 }),
                      S.removeAttribute("data-mce-selected"),
                      j.appendChild(S),
                      N.bind(U, "mousemove", l),
                      N.bind(U, "mouseup", c),
                      W != U &&
                        (N.bind(W, "mousemove", l), N.bind(W, "mouseup", c)),
                      (k = N.add(
                        j,
                        "div",
                  ...
                  return t
                    ...
                    : ((s = N.get("mceResizeHandle" + i)),
                      ...
                      r.ie && (s.contentEditable = !1),
                      N.bind(s, "mousedown", function (e) {
        ...
        function f(e) {
          ...
          if (!I && !a.removed)
            return (
              ...
              (r = N.$(r).closest(V ? "table" : "table,img,hr")[0]),
              t(r, j) &&
              (C(),
              (n = i.getStart(!0)),
              t(n, r) &&
                t(i.getEnd(!0), r) &&
                (!V || (r != n && "IMG" !== n.nodeName)))
                ? void u(r)
                : void d()
            );
        }
              ...
              : (C(),
                r.ie >= 11 &&
                  (a.on("mousedown click", function (e) {
                    ...
                    !I &&
                      /^(TABLE|IMG|HR)$/.test(t) &&
                      (a.selection.select(e.target, "TABLE" == t),
    ...
    r($, [z, _, w, T, U, W, V], function (e, t, n, r, i, o, a) {
      ...
      function c(e) {
        ...
        function i(e) {
          0 !== e.height &&
            ((c.length > 0 && o.isEqual(e, c[c.length - 1])) || c.push(e));
        }
        function s(e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (
              ...
              (o.setStart(e, t), o.setEnd(e, t + 1), !l(o))
            )
              return i(r(n(o), !1)), c;
          }
          t > 0 &&
            (o.setStart(e, t - 1), o.setEnd(e, t), l(o) || i(r(n(o), !1))),
            t < e.data.length &&
              (o.setStart(e, t), o.setEnd(e, t + 1), l(o) || i(r(n(o), !0)));
        }
        var c = [],
          u,
          f;
      ...
      var l = a.matchNodeNames("td th"),
        c = function (a, c) {
            ...
            if (t) {
              ...
              (S = M.createRng()),
                ...
                c &&
                  ...
                  S.setEnd(c, 0),
                  l(c) || g(c) || !(u = o(S))
                    ? M.add(c, M.create("br", { "data-mce-bogus": "1" }))
                    : ((S = u), M.remove(c))),
                L.setRng(S);
            }
          }
          var b,
            ...
            A,
            B,
            D = a.schema.getTextInlineElements(),
            L = a.selection,
            M = a.dom;
          "string" != typeof c &&
            ((A = c.merge), (B = c.data), (c = c.content)),
            /^ | $/.test(c) && (c = u(c)),
            (b = a.parser),
          ...
          P === H &&
            L.isCollapsed() &&
            M.isBlock(H.firstChild) &&
            v(H.firstChild) &&
            M.isEmpty(H.firstChild) &&
            ((S = M.createRng()),
            S.setStart(H.firstChild, 0),
            S.setEnd(H.firstChild, 0),
            L.setRng(S)),
            L.isCollapsed() ||
          ...
          if (
            ((N = b.parse(c, O)),
            s.isListFragment(N) && s.isParentBlockLi(M, x))
          )
            return (
              (S = s.insertAtCaret(C, M, a.selection.getRng(), N)),
          ...
          if ((a._selectionOverrides.showBlockCaretContainer(x), O.invalid)) {
            for (
              ...
              (x = k), (k = k.parentNode);
            (c = x == w ? w.innerHTML : M.getOuterHTML(x)),
              (c = C.serialize(
                b.parse(
                  c.replace(
        ...
        return function (u) {
          ...
          function p(e) {
            ...
            e.dataTransfer &&
              (u.selection.isCollapsed() &&
                ...
                ee.select(e.target),
              (t = u.selection.getContent()),
              t.length > 0 &&
                ((n = se + escape(u.id) + "," + escape(t)),
                e.dataTransfer.setData(le, n)));
          }
          function m(e) {
            var t;
            return e.dataTransfer &&
              ((t = e.dataTransfer.getData(le)), t && t.indexOf(se) >= 0)
              ? ((t = t.substr(se.length).split(",")),
                { id: unescape(t[0]), html: unescape(t[1]) })
              : null;
          }
          function g(e) {
            u.queryCommandSupported("mceInsertClipboardContent")
              ? u.execCommand("mceInsertClipboardContent", !1, { content: e })
          ...
          function v() {
            ...
            function c(e) {
              ...
              if (
                ...
                (s = u.schema.getTextBlockElements()),
                n != r &&
                  s[n.nodeName] &&
                  s[r.nodeName] &&
                ...
                return (
                  ...
                  (i = a(n, !1)),
                  (o = a(r, !0)),
                  C.isEmpty(r) || G(n).append(r.childNodes),
                  G(r).remove(),
                  i
                    ? 1 == i.nodeType
                      ? "BR" == i.nodeName
            ...
            function d(e, n) {
              ...
              if (
                ((c = e.startContainer), (d = e.startOffset), 3 == c.nodeType)
              )
                if (n) {
              ...
              if (
                ...
                if (1 == f.nodeType) {
                  ...
                  if (
                    ...
                    C.isEmpty(a) && i(d) && C.isEmpty(d) && n(a, f))
                  )
                    return C.remove(d), !0;
                      ...
                      if (
                        ...
                        e == r && ((t = n.startOffset), (i = e.firstChild)),
                          ...
                          i &&
                            (n.setStart(i, t),
                            n.setEnd(i, t),
                            u.selection.setRng(n));
                      }
                    });
                  }
                }),
                t.disconnect(),
                s.each(u.dom.select("span[mce-data-marked]"), function (e) {
                  ...
                  (n = u.selection.getRng()),
                    ...
                    r.length
                      ? ((i = C.createFragment()),
                        ...
                        a.appendChild(u.getDoc().createTextNode(s)),
                        (o = C.getParent(n.startContainer, C.isBlock)),
                        C.isEmpty(o) ? G(o).empty().append(i) : n.insertNode(i),
                        n.setStart(a.firstChild, 1),
                        n.setEnd(a.firstChild, 1),
                        u.selection.setRng(n))
                      : u.selection.setContent(s);
                }
              }),
          ...
          function y() {
            function e(e) {
              var t = Z.create("body"),
                n = e.cloneContents();
              return (
                t.appendChild(n), ee.serializer.serialize(t, { format: "html" })
              );
            }
            function n(n) {
              if (!n.setStart) {
            ...
            u.on("keydown", function (e) {
              ...
              if (!h(e) && (t == Q || t == J)) {
                ...
                e.preventDefault(),
                  u.setContent(""),
                  i.firstChild && Z.isBlock(i.firstChild)
                    ? u.selection.setCursorLocation(i.firstChild, 0)
                    : u.selection.setCursorLocation(i, 0),
                  u.nodeChanged();
              }
            });
          }
          ...
          function C() {
            u.settings.content_editable ||
              Z.bind(u.getDoc(), "mousedown mouseup", function (e) {
                var t;
          ...
          function N() {
            u.on("click", function (e) {
              ...
              /^(IMG|HR)$/.test(t.nodeName) &&
                "false" !== Z.getContentEditableParent(t) &&
                (e.preventDefault(),
                ee.getSel().setBaseAndExtent(t, 0, t, 1),
                u.nodeChanged()),
                "A" == t.nodeName &&
                  Z.hasClass(t, "mce-item-anchor") &&
                  (e.preventDefault(), ee.select(t));
            });
          }
          function E() {
            function e() {
            ...
            function t() {
              return (
                !ee.isCollapsed() &&
                Z.getParent(ee.getStart(), Z.isBlock) !=
                  Z.getParent(ee.getEnd(), Z.isBlock)
              );
            }
            u.on("keypress", function (n) {
              var r;
              return h(n) || (8 != n.keyCode && 46 != n.keyCode) || !t()
                ? void 0
                : ((r = e()),
          ...
          function k() {
            f() > 7 ||
              ...
              u.contentStyles.push(".mceHideBrInPre pre br {display: none}"),
              Z.addClass(u.getBody(), "mceHideBrInPre"),
              ne.addNodeFilter("pre", function (e) {
          ...
          function T() {
            Z.bind(u.getBody(), "mouseup", function () {
              var e,
                t = ee.getNode();
              "IMG" == t.nodeName &&
                ((e = Z.getStyle(t, "width")) &&
                  (Z.setAttrib(t, "width", e.replace(/[^0-9%]+/g, "")),
                  Z.setStyle(t, "width", "")),
                (e = Z.getStyle(t, "height")) &&
                  (Z.setAttrib(t, "height", e.replace(/[^0-9%]+/g, "")),
                  Z.setStyle(t, "height", "")));
            });
          }
          function R() {
            u.on("keydown", function (t) {
              ...
              if (
                ...
                "BLOCKQUOTE" === a.tagName &&
                  (u.formatter.toggle("blockquote", null, a),
                  (n = Z.createRng()),
                  n.setStart(r, 0),
                  n.setEnd(r, 0),
                  ee.setRng(n));
          ...
          function L() {
            u.on("keydown", function (e) {
              ...
              h(e) ||
                e.keyCode != J ||
                ((t = u.getDoc().selection.createRange()),
                t &&
                  t.item &&
                  (e.preventDefault(),
                  u.undoManager.beforeChange(),
                  Z.remove(t.item(0)),
                  u.undoManager.add()));
            });
          }
          ...
          function P() {
            f() < 9 &&
              (ne.addNodeFilter("noscript", function (e) {
                for (var t = e.length, n, r; t--; )
                  (n = e[t]),
                    (r = n.firstChild),
          ...
          return (
            ...
            ae &&
              ...
              q(),
              a.iOS ? (F(), z(), V()) : b()),
            oe && a.ie < 11 && (x(), _(), k(), T(), L(), M(), P(), H()),
            a.ie >= 11 && (z(), S()),
            a.ie && (b(), W(), j()),
            ie && (x(), w(), E(), A(), B(), I(), U(), S()),
            { refreshContentEditable: Y, isHidden: X }
          );
        };
      },
    ),
      ...
      function r(e) {
        ...
        function c() {
          ...
          if (
            ...
            var n = g.element;
            if (
              ((t = e.fire("drop", { targetClone: n })), t.isDefaultPrevented())
            )
              return;
            (n = t.targetClone),
    ...
    r(
      ...
      function (e, t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g) {
        ...
        function y(c) {
          ...
          function j(e, t, n) {
            var r, i, o;
            return !n.collapsed && ((r = _(n)), x(r))
              ? V($(r))
              : ((i = L(e, n)),
                t(i)
                  ? V($(i.getNode(-1 == e)))
                  : ((o = -1 == e ? ee.prev(i) : ee.next(i)),
                    t(o) ? (-1 === e ? q(e, i, o) : q(e, o, i)) : void 0));
          }
          function Y() {
            function e(e, t) {
              var n = t(k());
          ...
          function J() {
            oe &&
              (oe.removeAttribute("data-mce-selected"),
              c.$("#" + ie).remove(),
              (oe = null));
          }
          function Q() {
          ...
          var Z = c.getBody(),
            ...
            ae = c.$;
          return (
            e.ceFalse && (Y(), X()), { showBlockCaretContainer: U, destroy: Q }
          );
        }
        var b = f.curry,
          ...
          (A.prototype = {
              ...
              if (n.getElement() && w.contentEditable) {
                ...
                a &&
                  ...
                  r.hidden_input &&
                    ...
                    (B.insertAfter(
                      B.create("input", { type: "hidden", name: i }),
                      i,
                    ),
                    (n.hasHiddenInput = !0)),
                  ...
                  B.bind(a, "submit reset", n.formEventDelegate),
                  n.on("reset", function () {
            ...
            init: function () {
              function e(n) {
                var r = L.get(n),
                  ...
                  o;
                if (
                  ((i = L.urls[n] || t.documentBaseUrl.replace(/\/$/, "")),
                  (n = I(n)),
                  r && -1 === O(m, n))
                ) {
                  if (
                    (P(L.dependencies(n), function (t) {
                      e(t);
                    }),
                    t.plugins[n])
                  )
                ...
                n.theme &&
                  ("function" != typeof n.theme
                    ? ((n.theme = n.theme.replace(/-/, "")),
                      (c = D.get(n.theme)),
                      (t.theme = new c(t, D.urls[n.theme])),
                      t.theme.init &&
                        t.theme.init(
                          t,
                          D.urls[n.theme] ||
              ...
              if (
                ...
                B.setAttrib(y, "src", u || 'javascript:""'),
                (t.contentAreaContainer = l.iframeContainer),
                (t.iframeElement = y),
                (s = B.add(l.iframeContainer, y)),
                W)
              )
                try {
                  t.getDoc();
              ...
              l.editorContainer &&
                ((B.get(l.editorContainer).style.display = t.orgDisplay),
                (t.hidden = B.isHidden(l.editorContainer))),
            ...
            initContentBody: function (t) {
              ...
              r.inline || (n.getElement().style.visibility = n.orgVisibility),
                ...
                n.readonly ||
                  (n.inline &&
                    "static" == B.getStyle(p, "position", !0) &&
                ...
                r.browser_spellcheck ||
                  r.gecko_spellcheck ||
                  ((h.body.spellcheck = !1),
                  B.setAttrib(p, "spellcheck", "false")),
                (n.quirks = new x(n)),
                n.fire("PostRender"),
            ...
            show: function () {
              ...
              e.hidden &&
                ...
                e.inline
                  ...
                  : (B.show(e.getContainer()), B.hide(e.id)),
                e.load(),
                e.fire("show"));
            },
            hide: function () {
              var e = this,
                t = e.getDoc();
              e.hidden ||
                (W && t && !e.inline && t.execCommand("SelectAll"),
                e.save(),
                e.inline
                  ? ((e.getBody().contentEditable = !1),
                    e == e.editorManager.focusedEditor &&
                      (e.editorManager.focusedEditor = null))
                  : (B.hide(e.getContainer()),
                    B.setStyle(e.id, "display", e.orgDisplay)),
                (e.hidden = !0),
                e.fire("hide"));
            },
            isHidden: function () {
                ...
                return (
                  ...
                  /TEXTAREA|INPUT/i.test(n.nodeName)
                    ...
                    : (t.inline || (n.innerHTML = r),
                      (i = B.getParent(t.id, "form")) &&
                        P(i.elements, function (e) {
            ...
            getContainer: function () {
              ...
              return (
                e.container ||
                  (e.container = B.get(e.editorContainer || e.id + "_parent")),
                e.container
              );
            },
            ...
            getElement: function () {
              return (
                this.targetElm || (this.targetElm = B.get(this.id)),
                this.targetElm
              );
            },
            getWin: function () {
            ...
            remove: function () {
              ...
              e.removed ||
                ...
                e.hasHiddenInput && B.remove(e.getElement().nextSibling),
                e.inline ||
                  (W && 10 > W && e.getDoc().execCommand("SelectAll", !1, null),
                  B.setStyle(e.id, "display", e.orgDisplay),
                  (e.getBody().onload = null)),
                e.fire("remove"),
                e.editorManager.remove(e),
                B.remove(e.getContainer()),
              ...
              if (!t.destroyed) {
                ...
                e ||
                  ...
                  n &&
                    ...
                    B.unbind(n, "submit reset", t.formEventDelegate)),
                ...
                switch (e.mode) {
                  ...
                  case "specific_textareas":
                    g(p.select("textarea"), function (t) {
                      (e.editor_deselector && s(t, e.editor_deselector)) ||
                        (e.editor_selector && !s(t, e.editor_selector)) ||
                        n.push(t);
                    });
                }
                return n;
