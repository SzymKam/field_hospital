  ...
  (e.prototype = {
    ...
    add: function (b) {
      ...
      if (
        ...
        return !1;
      for (
        f.config["case-sensitive"] || (b = b.toLowerCase()), e = h.length;
        e--;
    ...
    init: function () {
      ...
      return (
        (d = this),
        (d.config = a.extend({}, d.defaults, d.options, d.getDataOptions())),
        (b = d.$elem.text()),
        d.$elem.empty(),
        (d.$type_zone = a(c.createElement("input"))
          .addClass(d.config["type-zone-class"])
          .attr("contenteditable", !0)),
        d.$elem.addClass(d.config["tag-box-class"]).append(d.$type_zone),
    ...
    remove: function (b) {
      ...
      if (b)
        for (e = c.tags.length; e--; )
          c.tags[e][0].innerHTML === b[0].innerHTML && c.tags.splice(e, 1);
      else b = c.tags.pop();
      return (
        (d = d || b.pure_text),
        b.remove(),
        c.config["edit-on-delete"] && (c.emptyInput(), c.valInput(b.pure_text)),
    ...
    removeSpecialKeys: function (b) {
      ...
      for (e in c.keys[h])
        c.keys[h].hasOwnProperty(e) && c.keys[h][e] === g && (c.keys[h][e] = d);
      return c.keys[h];
    },
    reset: function () {
