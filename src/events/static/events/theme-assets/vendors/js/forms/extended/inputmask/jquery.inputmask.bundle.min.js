...
!(function (a) {
  ...
  function d(b, c) {
    var d = b.getAttribute("type"),
      e =
        ("INPUT" === b.tagName && a.inArray(d, c.supportsInputType) !== -1) ||
        b.isContentEditable ||
        "TEXTAREA" === b.tagName;
  ...
  function h(e, f, g) {
    function i(a, b, c) {
      ...
      do {
        ...
        ((void 0 === ga || i < ga) && (null !== e.fn || "" !== e.def)) ||
        b > i
      );
    ...
    function q(a, b) {
      for (
        var c,
          d = a,
          e = o(),
          f = m().validPositions[e] || v(0)[0],
          h =
            void 0 !== f.alternation
              ? f.locator[f.alternation].toString().split(",")
              : [],
          i = 0;
        i < d.length &&
        ((c = d[i]),
        !(
          c.match &&
          ((g.greedy && c.match.optionalQuantifier !== !0) ||
            ((c.match.optionality === !1 || c.match.newBlockMarker === !1) &&
              c.match.optionalQuantifier !== !0)) &&
          (void 0 === f.alternation ||
            f.alternation !== c.alternation ||
            (void 0 !== c.locator[f.alternation] &&
              A(c.locator[f.alternation].toString().split(","), h)))
        ) ||
          (b === !0 &&
    ...
    function v(b, c, d) {
        ...
        function j(f, h, l) {
          ...
          function s(a, c) {
            return (
              null === a.match.fn &&
              null !== c.match.fn &&
              c.match.fn.test(a.match.def, m(), b, !1, g, !1)
            );
          }
          if (k > 1e4)
            throw (
          ...
          if (k === b && void 0 === f.matches)
            return n.push({ match: f, locator: h.reverse(), cd: p }), !0;
          if (void 0 !== f.matches) {
            if (f.isGroup && l !== f) {
              ...
              if (A === -1 || "string" == typeof A) {
                ...
                else for (B = 0; B < w.matches.length; B++) E.push(B);
                for (var F = 0; F < E.length; F++) {
                  if (
                    ...
                    (d = r(k, B) || D.slice()),
                    (f =
                      j(w.matches[B] || c.matches[B], [B].concat(h), l) || f),
                    f !== !0 &&
                      void 0 !== f &&
                      E[E.length - 1] < w.matches.length)
                  ) {
                    var G = a.inArray(f, c.matches) + 1;
                    c.matches.length > G &&
                      ((f = j(
                        c.matches[G],
                        [G].concat(h.slice(1, h.length)),
                        l,
                      )),
                      f &&
                        (E.push(G.toString()),
                  ...
                  for (var H = 0; H < v.length; H++) {
                    ...
                    for (var K = 0; K < x.length; K++) {
                      ...
                      if (
                        ("string" != typeof A ||
                          a.inArray(I.locator[I.alternation].toString(), E) !==
                            -1) &&
                        (I.match.def === L.match.def || s(I, L))
                      ) {
                        (J = I.match.mask === L.match.mask),
                          L.locator[I.alternation]
                            .toString()
                            .indexOf(I.locator[I.alternation]) === -1 &&
                            ((L.locator[I.alternation] =
                              L.locator[I.alternation] +
                              "," +
                            ...
                            null == I.match.fn &&
                              ((L.na =
                                L.na || I.locator[I.alternation].toString()),
                              L.na.indexOf(I.locator[I.alternation]) === -1 &&
                                (L.na =
                                  L.na + "," + I.locator[I.alternation])));
                        break;
                      }
                    }
                    J || x.push(I);
              ...
              f.isQuantifier &&
              l !== c.matches[a.inArray(f, c.matches) - 1]
            )
              for (
                var M = f, N = d.length > 0 ? d.shift() : 0;
                N < (isNaN(M.quantifier.max) ? N + 1 : M.quantifier.max) &&
                k <= b;
                N++
              ) {
                  ...
                  if ("" !== b.def)
                    if (0 === c.length) c = b.locator.slice();
                      ...
                      for (var d = 0; d < c.length; d++)
                        b.locator[d] &&
                          c[d].toString().indexOf(b.locator[d]) === -1 &&
                          (c[d] += "," + b.locator[d]);
                })),
          c
        );
      ...
      function h(a) {
        return g.keepStatic &&
          ...
          a[0].match.optionality !== !0 &&
          a[0].match.optionalQuantifier !== !0 &&
          null === a[0].match.fn &&
      ...
      if (b > -1) {
        if (void 0 === c) {
          for (
            var r, s = b - 1;
            void 0 === (r = m().validPositions[s] || m().tests[s]) && s > -1;
      ...
      return (
        ...
        void 0 !== c && m().tests[b]
          ? h(a.extend(!0, [], n))
          : ((m().tests[b] = a.extend(!0, [], n)), h(m().tests[b]))
      );
    }
    function w() {
      return (
    ...
    function x(a) {
      return (
        (void 0 !== m().buffer && a !== !0) || (m().buffer = i(!0, o(), !0)),
        m().buffer
      );
    }
    function y(a, b, c) {
      ...
      else for (d = a; d < b; d++) delete m().validPositions[d];
      for (d = a; d < b; d++)
    ...
    function z(a, c, d) {
      switch (g.casing || c.casing) {
        ...
        case "title":
          ...
          a =
            0 === d || (e && e.input === String.fromCharCode(b.keyCode.SPACE))
              ? a.toUpperCase()
              : a.toLowerCase();
      }
      return a;
    ...
    function B(c, d, e, f, h) {
      ...
      function j(b, d, e) {
        ...
        return (
          a.each(v(b), function (j, k) {
            for (
              var l = k.match, q = d ? 1 : 0, r = "", t = l.cardinality;
              t > q;
              t--
            )
              r += F(b - (t - 1));
            if (
              ...
              (h =
                null != l.fn
                  ? l.fn.test(r, m(), b, e, g, i(c))
                  : (d === l.def || d === g.skipOptionalPartCharacter) &&
                    "" !== l.def && { c: l.placeholder || l.def, pos: b }),
              h !== !1)
            ) {
              ...
              if (
                ...
                void 0 !== h.pos &&
                h.pos !== b &&
                ((v = h.pos), y(b, v, x().slice()), v !== b)
              )
                return (h = a.extend(h, B(v, u, !0))), !1;
              return (
                (h === !0 || void 0 !== h.pos || void 0 !== h.c) &&
                (j > 0 && n(!0),
                s(v, a.extend({}, k, { input: z(u, l, v) }), f, i(c)) ||
                  (h = !1),
                !1)
              );
            }
      ...
      function k(b, c, d) {
        ...
        if (void 0 !== h) {
          q = parseInt(e);
          var u =
            void 0 !== j.locator[j.alternation || h]
              ? j.locator[j.alternation || h]
              : p[0];
          ...
          a.each(v(q, x ? x.locator : void 0, q - 1), function (e, i) {
            ...
            for (var j = 0; j < p.length; j++) {
              ...
              if (
                u < p[j] &&
                (void 0 === i.na || a.inArray(p[j], i.na.split(",")) === -1)
              ) {
                m().validPositions[q] = a.extend(!0, {}, i);
                var z = m().validPositions[q].locator;
                for (
                  m().validPositions[q].locator[h] = parseInt(p[j]),
                    null == i.match.fn
                      ? (w.input !== i.match.def &&
                          ((y = !0),
                          w.generatedInput !== !0 && t.push(w.input)),
                        x++,
                        (m().validPositions[q].generatedInput =
                          !/[0-9a-bA-Z]/.test(i.match.def)),
                        (m().validPositions[q].input = i.match.def))
                      : (m().validPositions[q].input = w.input),
                    k = q + 1;
                  k < o(void 0, !0) + 1;
                  k++
                )
                  (l = m().validPositions[k]),
                    l && l.generatedInput !== !0 && /[0-9a-bA-Z]/.test(l.input)
                      ? t.push(l.input)
                      : k < b && v++,
                    delete m().validPositions[k];
                for (
                  y && t[0] === i.match.def && t.shift(), n(!0), s = !0;
                  t.length > 0;

                ) {
                  var A = t.shift();
                  if (
                    A !== g.skipOptionalPartCharacter &&
                    !(s = B(o(void 0, !0) + 1, A, !1, f, !0))
                  )
                    break;
                }
                if (s) {
      ...
      function u(b) {
        ...
        var d, e;
        for (c++; c < b; c++)
          void 0 === m().validPositions[c] &&
            (g.jitMasking === !1 || g.jitMasking > c) &&
            ((e = v(c, r(c - 1).locator, c - 1).slice()),
            "" === e[e.length - 1].match.def && e.pop(),
            (d = q(e)),
            d &&
              (d.match.def === g.radixPointDefinitionSymbol ||
                !C(c, !0) ||
                (a.inArray(g.radixPoint, x()) < c &&
                  d.match.fn &&
                  d.match.fn.test(H(c), m(), c, !1, g))) &&
              ((E = j(
                c,
                d.match.placeholder ||
                  (null == d.match.fn
              ...
              E !== !1 &&
                (m().validPositions[E.pos || c].generatedInput = !0)));
      }
      e = e === !0;
      var w = c;
      ...
      if (
        (u(w),
        i(c) && (P(void 0, b.keyCode.DELETE, c), (w = m().p)),
        w < m().maskLength && ((E = j(w, d, e)), (!e || f === !0) && E === !1))
      ) {
        var I = m().validPositions[w];
        if (
          !I ||
          null !== I.match.fn ||
          (I.match.def !== d && d !== g.skipOptionalPartCharacter)
        ) {
          if (
            (g.insertMode || void 0 === m().validPositions[D(w)]) &&
            !C(w, !0)
          ) {
            var J = v(w).slice();
            ...
            var K = q(J, !0);
            K &&
              ((K = K.match.placeholder || K.match.def),
              j(w, K, e),
      ...
      return (
        E === !1 && g.keepStatic && !e && h !== !0 && (E = k(w, d, e)),
        E === !0 && (E = { pos: w }),
        a.isFunction(g.postValidation) &&
          E !== !1 &&
          !e &&
          f !== !0 &&
          (E = !!g.postValidation(x(!0), E, g) && E),
        void 0 === E.pos && (E.pos = w),
        E === !1 && (n(!0), (m().validPositions = a.extend(!0, {}, G))),
        E
      );
    }
    function C(a, b) {
    ...
    function D(a, b) {
      ...
      for (
        var d = a;
        ++d < c &&
        ((b === !0 && (s(d).match.newBlockMarker !== !0 || !C(d))) ||
          (b !== !0 && !C(d)));
    ...
    function E(a, b) {
      ...
      for (
        ;
        --d > 0 &&
        ((b === !0 && s(d).match.newBlockMarker !== !0) ||
          (b !== !0 &&
            !C(d) &&
            ((c = v(d)),
        ...
        (a.each(k, function (b, d) {
          if (void 0 !== d) {
            ...
            if (!j() || e || g.autoUnmask) {
              var s = e
                ? b
                : null == k.match.fn && k.match.optionality && h + 1 < m().p
                ? h + 1
                : m().p;
            ...
            if (
              ...
              ((q = g.onBeforeWrite(f, x(), q.forwardPosition, g)),
          ...
          a.valHooks[b] = {
            get: function (a) {
              if (a.inputmask) {
                ...
                var b = c(a);
                return o(void 0, void 0, a.inputmask.maskset.validPositions) !==
                  -1 || g.nullable !== !0
                  ? b
                  : "";
              }
        ...
        return this.inputmask
          ? this.inputmask.opts.autoUnmask
            ...
            ? document.activeElement === this && g.clearMaskOnLostFocus
              ? (ia ? M(x().slice()).reverse() : M(x().slice())).join("")
              : h.call(this)
            : ""
          : h.call(this);
      }
    ...
    function P(c, d, e, f) {
            ...
            if (h) {
              if (
                ...
                void 0 !== h.alternation &&
                  h.locator[h.alternation] !== f.locator[h.alternation])
              )
                break;
              f = h;
            }
      ...
      d === b.keyCode.BACKSPACE && (e.end - e.begin < 1 || g.insertMode === !1)
        ...
        : d === b.keyCode.DELETE &&
          e.begin === e.end &&
          ((e.end = C(e.end, !0) ? e.end + 1 : D(e.end) + 1),
          void 0 === m().validPositions[e.begin] ||
            (m().validPositions[e.begin].input !== g.groupSeparator &&
              m().validPositions[e.begin].input !== g.radixPoint) ||
            e.end++),
    ...
    function Q(d) {
      ...
      if (
        ...
        (h === b.keyCode.HOME && !d.shiftKey) || h === b.keyCode.PAGE_UP
          ? (d.preventDefault(), K(e, 0, d.shiftKey ? i.begin : 0, !0))
          : ((g.undoOnEscape && h === b.keyCode.ESCAPE) ||
              (90 === h && d.ctrlKey)) &&
            d.altKey !== !0
          ? (I(e, !0, !1, da.split("")), f.trigger("click"))
          : h !== b.keyCode.INSERT || d.shiftKey || d.ctrlKey
          ? g.tabThrough === !0 && h === b.keyCode.TAB
            ? (d.shiftKey === !0
                ? (null === s(i.begin).match.fn && (i.begin = D(i.begin)),
                  (i.end = E(i.begin, !0)),
                  (i.begin = E(i.end, !0)))
                : ((i.begin = D(i.begin, !0)),
                  (i.end = D(i.begin, !0)),
                  i.end < m().maskLength && i.end--),
              i.begin < m().maskLength &&
                (d.preventDefault(), K(e, i.begin, i.end)))
            : g.insertMode !== !1 ||
              d.shiftKey ||
              (h === b.keyCode.RIGHT
                ? setTimeout(function () {
          ...
          : ((g.insertMode = !g.insertMode),
            K(
              e,
              g.insertMode || i.begin !== m().maskLength
                ? i.begin
                : i.begin - 1,
            ));
        ...
        if (
          ...
          if (
            ...
            G(
              i,
              s,
              g.numericInput && void 0 === q.caret ? E(l) : l,
              c,
              d !== !0,
            ),
              d !== !0 &&
    ...
    function S(b) {
      ...
      if (
        (j === (ia ? w().reverse() : w()).slice(0, i.begin).join("") &&
          (j = ""),
      ...
      return (
        I(d, !1, !1, ia ? l.split("").reverse() : l.toString().split("")),
    ...
    function T(c) {
      ...
      if (x().join("") !== e) {
        ...
        if (
          (f.begin > e.length && (K(d, e.length), (f = K(d))),
          x().length - e.length !== 1 ||
    ...
    function V(a) {
      ...
      (!g.showMaskOnHover || (g.showMaskOnHover && "" === c))
        ? b.inputmask._valueGet() !== x().join("") && G(b, x(), D(o()))
        : na === !1 && K(b, D(o())),
            ...
            switch (g.positionCaretOnClick) {
              ...
              default:
                ...
                if (f < i) K(d, C(f) || C(f - 1) ? f : D(f));
                  ...
                  (("" !== j &&
                    x()[i] !== j &&
                    s(i).match.optionalQuantifier !== !0) ||
                    (!C(i, !0) && s(i).match.def === j)) &&
                    (i = D(i)),
                    K(d, i);
                }
            }
    ...
    function aa(a) {
      da !== x().join("") && fa.trigger("change"),
        g.clearMaskOnLostFocus &&
          o() === -1 &&
          ea.inputmask._valueGet &&
          ea.inputmask._valueGet() === w().join("") &&
          ea.inputmask._valueSet(""),
        g.removeMaskOnSubmit &&
          (ea.inputmask._valueSet(ea.inputmask.unmaskedvalue(), !0),
          setTimeout(function () {
            G(ea, x());
          }, 0));
    }
    ...
    function ca(b) {
      if (
        ...
        ("rtl" === ea.dir || g.numericInput) &&
          ((ea.dir = "ltr"),
          ea.removeAttribute("dir"),
          (ea.inputmask.isRTL = !0),
          (ia = !0)),
        j &&
          (ea.setAttribute("inputmode", "verbatim"),
          ea.setAttribute("x-inputmode", "verbatim")),
        oa.off(ea),
        O(ea),
        d(ea, g) &&
          (oa.on(ea, "submit", aa),
          oa.on(ea, "reset", ba),
          oa.on(ea, "mouseenter", _),
          oa.on(ea, "blur", $),
          oa.on(ea, "focus", V),
          oa.on(ea, "mouseleave", W),
          oa.on(ea, "click", X),
          oa.on(ea, "dblclick", Y),
          oa.on(ea, "paste", S),
          oa.on(ea, "dragdrop", S),
          oa.on(ea, "drop", S),
          oa.on(ea, "cut", Z),
          oa.on(ea, "complete", g.oncomplete),
          oa.on(ea, "incomplete", g.onincomplete),
          oa.on(ea, "cleared", g.oncleared),
          g.inputEventOnly !== !0 &&
            (oa.on(ea, "keydown", Q), oa.on(ea, "keypress", R)),
          oa.on(ea, "compositionstart", a.noop),
          oa.on(ea, "compositionend", a.noop),
          oa.on(ea, "input", T)),
        oa.on(ea, "setvalue", U),
        w(),
        "" !== ea.inputmask._valueGet() ||
          g.clearMaskOnLostFocus === !1 ||
          document.activeElement === ea)
      ) {
        var c = a.isFunction(g.onBeforeMask)
          ? g.onBeforeMask(ea.inputmask._valueGet(), g) ||
            ea.inputmask._valueGet()
          : ea.inputmask._valueGet();
        I(ea, !0, !1, c.split(""));
        var e = x().slice();
      ...
      switch (e.action) {
        ...
        case "isValid":
          g.numericInput && (ia = !0),
            e.value
              ? ((ha = e.value.split("")),
                I(void 0, !1, !0, ia ? ha.reverse() : ha))
              : (e.value = x().join(""));
          for (
            var pa = x(), qa = L(), ra = pa.length - 1;
            ra > qa && !C(ra);
            ra--
          );
        ...
        case "remove":
          ...
          Object.getOwnPropertyDescriptor && Object.getPrototypeOf
            ? ((sa = Object.getOwnPropertyDescriptor(
              ...
              sa &&
                ea.inputmask.__valueGet &&
                Object.defineProperty(ea, "value", {
                  get: ea.inputmask.__valueGet,
                  set: ea.inputmask.__valueSet,
                  configurable: !0,
                }))
            : document.__lookupGetter__ &&
              ea.__lookupGetter__("value") &&
              ea.inputmask.__valueGet &&
              (ea.__defineGetter__("value", ea.inputmask.__valueGet),
      ...
      b.extendAliases({
        numeric: {
          ...
          postFormat: function (c, d, e) {
            ...
            if (
              ...
              (j = j.replace("?", "!")),
                "" !== e.radixPoint &&
                  m.length > 1 &&
                  (j += (h === e.radixPoint ? "!" : e.radixPoint) + m[1]);
            }
            ...
            return (
              (c[p] = h),
              (p =
                e.numericInput && isFinite(d) ? c.join("").length - p - 1 : p),
              e.numericInput &&
                ((c = c.reverse()),
                a.inArray(e.radixPoint, c) < p &&
                  c.join("").length - e.suffix.length !== p &&
                  (p -= 1)),
              { pos: p, refreshFromBuffer: o, buffer: c }
            );
          },
            ...
            if (!e) {
              ...
              if (
                ...
                if ("0" === i && void 0 === c.validPositions[d - 1])
                  return { pos: d, remove: h.length - 1 };
              } else {
                d -= f.prefix.length;
                var j = a.inArray(f.radixPoint, h),
                  k = h
                    .slice(0, j !== -1 ? j : void 0)
                    .join("")
                ...
                if (k && (j === -1 || d <= j)) {
                  ...
                  if (
                    ...
                    return (
                      c.buffer.splice(k.index + f.prefix.length, 1),
                      {
          ...
          onBeforeMask: function (a, c) {
            if (
              (c.numericInput === !0 && (a = a.split("").reverse().join("")),
