  ...
  (l = {
    ...
    (h = {
      ...
      removeClass: function (a, b) {
        var c, d, e, f;
        for (
          d = b.split(/\s+/), c = " " + a.className + " ", e = 0, f = d.length;
          f > e;
          ++e
        )
          c = c.replace(" " + d[e] + " ", " ");
      ...
      invokeCallbackArrayHelper: function (a) {
        var b;
        return Array.isArray(a) && ((b = j[a[0]]), "function" == typeof b)
      ...
      flipPlacement: function (a) {
        if (a.isRtl && !a._isFlipped) {
          ...
          for (c in d)
            (b = d[c]),
              a.hasOwnProperty(b) && w.hasOwnProperty(a[b]) && (a[b] = w[a[b]]);
          a._isFlipped = !0;
        }
      },
    }),
          ...
          g
            ? "top" === a.placement || "bottom" === a.placement
              ...
              : ("left" === a.placement || "right" === a.placement) &&
                ...
                "center" === g
                  ? (l.style.top =
                      Math.floor(b / 2 - l.offsetHeight / 2) + "px")
                  : (l.style.top = g + "px"))
      ...
      render: function (a, b, c) {
        ...
        if (
          ...
          (q = {
            ...
            buttons: {
              showPrev:
                h.valOrDefault(a.showPrevButton, this.opt.showPrevButton) &&
    ...
    (a = function (a) {
      var d,
        ...
        L = function (a, b, c) {
          var d, e;
          if (
            ((u = a || 0), (A = b || {}), (d = F()), (e = h.getStepTarget(d)))
          )
            return void c(u);
          if (!e) {
            if (
        ...
        M = function (a) {
          ...
          u !== a &&
            ...
            d.render(c, a, function (a) {
              a ? H(b) : b(),
                c.nextOnTargetClick && h.addEvtListener(e, "click", G);
            }),
            N();
        },
        N = function () {
      ...
      (this.getCalloutManager = function () {
        return (
          ("undefined" == typeof k ? "undefined" : n(k)) === q && (k = new c()),
          k
        );
      }),
              ...
              return b
                ? (h.invokeEventCallbacks("start"),
                  ...
                  void (h.getStepTarget(F())
                    ? f.showStep(a)
                    : (h.invokeEventCallbacks("error"),
                      E("skipIfNoElement") && f.nextStep(!1))))
                : void f.endTour(!1, !1);
            }),
            this
          );
        ...
        (this.endTour = function (a, b) {
          ...
          return (
            ...
            this.isActive &&
              ((this.isActive = !1), t && b && h.invokeEventCallbacks("end")),
