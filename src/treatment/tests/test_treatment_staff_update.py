...
from api.tests.factories.medical_staff_factory import MedicalStaffFactory
from api.tests.factories.user_factory import UserFactory


class StaffUpdateTest(TestCase):
    def setUp(self) -> None:
        self.client = Client()
        self.user = UserFactory()
        self.medical_staff = MedicalStaffFactory()
        self.url = reverse("staff-update", kwargs={"pk": self.medical_staff.id})
